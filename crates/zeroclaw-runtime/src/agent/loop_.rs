...
pub(crate) use super::turn::STREAM_CHUNK_MIN_CHARS;
...
pub use super::turn::scrub_credentials;

pub use super::turn::{DraftEvent, PROGRESS_MIN_INTERVAL_MS, StreamDelta};
...
#[cfg(test)]
pub(crate) use super::turn::maybe_inject_channel_delivery_defaults;
...
pub async fn run_tool_call_loop(
    ...
    for iteration in 0..max_iterations {
        ...
        super::turn::preflight_history_maintenance(history, context_token_budget, iteration);
        ...
        let prepared_messages = super::turn::prepare_messages_for_iteration(
            history,
            multimodal_config,
        ...
        let super::turn::PreparedToolCalls {
            mut ordered_results,
            executable_indices,
            executable_calls,
        } = super::turn::prepare_tool_calls(
            &ctx,
            &tool_calls,
        ...
        super::turn::record_executed_outcomes(
            &ctx,
            &executable_indices,
            &executable_calls,
            executed_outcomes,
        ...
        let super::turn::CollectedResults {
            individual_results,
            tool_results,
            detection_relevant_output,
        } = super::turn::collect_tool_results(
            ordered_results,
            &tool_calls,
            history,
            &mut loop_detector,
        ...
        super::turn::check_identical_output_abort(
            &detection_relevant_output,
            loop_started_at,
            pacing,
